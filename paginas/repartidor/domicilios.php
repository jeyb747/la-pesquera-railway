...
<head>
    ...
    <link rel="stylesheet" href="/version_final/css/repartidor.css?v=1">
</head>
<body>
<header class="delivery-topbar">
    ...
    <a href="<?= $_SESSION['rol'] == 'admin' ? '/version_final/paginas/admin/dashboard.php' : '/version_final/index.php' ?>" class="btn btn-warning">
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <div class="action-group">
                                    <a href="/version_final/paginas/repartidor/ver_domicilio.php?id=<?= htmlspecialchars($row['id']) ?>" class="btn btn-outline-primary">
