...
$id = intval($_GET['id'] ?? 0);
if ($id <= 0) {
    header("Location: /version_final/paginas/repartidor/domicilios.php?mensaje=error");
    exit();
}
...
<header class="delivery-topbar">
    ...
    <a href="/version_final/paginas/repartidor/domicilios.php" class="btn btn-warning">
