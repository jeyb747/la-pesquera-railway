...
<head>
    ...
    <link class="modulo-css" rel="stylesheet" href="/version_final/css/admin/reservas.css">
</head>
<body>
                    ...
                    <table class="table table-borderless align-middle header-styled-table">
                        ...
                        <?php while($row = mysqli_fetch_assoc($resultado)) { ?>
                            <tr class="border-bottom">
                                ...
                                <td class="text-center">
                                    <form action="/version_final/php/controlador/reservas/estado.php" method="POST" class="m-0">
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center gap-1">
                                        <a href="/version_final/php/controlador/reservas/eliminar.php?id=<?= $row['id'] ?>" 
