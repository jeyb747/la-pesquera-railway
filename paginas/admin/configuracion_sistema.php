...
<head>
    ...
    <link rel="stylesheet" href="/version_final/css/admin/usuarios.css">
</head>
<body>

<div class="wrapper d-flex">
    <?php include($_SERVER['DOCUMENT_ROOT'] . "/version_final/includes/sidebar.php"); ?>

    <div class="main-content flex-grow-1 p-4">
        <?php include($_SERVER['DOCUMENT_ROOT'] . "/version_final/includes/topbar.php"); ?>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm rounded-4 p-4 text-center h-100 d-flex flex-column justify-content-between">
                        ...
                        <a href="/version_final/paginas/admin/configuracion/config_roles.php" class="btn btn-outline-primary rounded-pill w-100 mt-4 fw-medium">
                ...
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm rounded-4 p-4 text-center h-100 d-flex flex-column justify-content-between">
                        ...
                        <a href="/version_final/paginas/admin/categorias.php" class="btn btn-outline-warning rounded-pill w-100 mt-4 fw-medium">
                ...
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm rounded-4 p-4 text-center h-100 d-flex flex-column justify-content-between">
                        ...
                        <a href="/version_final/paginas/admin/configuracion/config_usuarios.php" class="btn btn-outline-info rounded-pill w-100 mt-4 fw-medium">
                            Gestionar Tabla <i class="bi bi-arrow-right ms-1"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm rounded-4 p-4 text-center h-100 d-flex flex-column justify-content-between">
                        ...
                        <a href="/version_final/paginas/admin/configuracion/config_reservas.php" class="btn btn-outline-warning rounded-pill w-100 mt-4 fw-medium">
                            Gestionar Tabla <i class="bi bi-arrow-right ms-1"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm rounded-4 p-4 text-center h-100 d-flex flex-column justify-content-between">
                        ...
                        <a href="/version_final/paginas/admin/configuracion/config_productos.php" class="btn btn-outline-success rounded-pill w-100 mt-4 fw-medium">
                            Gestionar Tabla <i class="bi bi-arrow-right ms-1"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm rounded-4 p-4 text-center h-100 d-flex flex-column justify-content-between">
                        ...
                        <a href="/version_final/paginas/admin/configuracion/config_pedidos.php" class="btn btn-outline-secondary rounded-pill w-100 mt-4 fw-medium">
                            Gestionar Tabla <i class="bi bi-arrow-right ms-1"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm rounded-4 p-4 text-center h-100 d-flex flex-column justify-content-between">
                        ...
                        <a href="/version_final/paginas/admin/configuracion/config_domicilios.php" class="btn btn-outline-danger rounded-pill w-100 mt-4 fw-medium">
                            Gestionar Tabla <i class="bi bi-arrow-right ms-1"></i>
                        </a>
                    </div>
                </div>
