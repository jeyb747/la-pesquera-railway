...
<head>
    ...
    <link class="modulo-css" rel="stylesheet" href="/version_final/css/admin/domicilios.css">
</head>
<body>
                        ...
                        <?php foreach($domicilios as $row) { ?>
                            <tr class="border-bottom">
                                ...
                                <td class="text-center">
                                    <form action="/version_final/php/controlador/domicilios/estado.php" method="POST" class="m-0">
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center gap-1">
                                        <a href="/version_final/paginas/repartidor/ver_domicilio.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-outline-primary rounded-pill px-3">
                    ...
                    <?php foreach($domicilios as $row) { ?>
                        <article class="delivery-card-mobile">
                            ...
                            <div class="delivery-card-footer">
                                ...
                                <a href="/version_final/paginas/repartidor/ver_domicilio.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-outline-primary rounded-pill">
                                    <i class="bi bi-eye me-1"></i> Ver
                                </a>
                            </div>
                        </article>
