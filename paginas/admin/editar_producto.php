...
<head>
    ...
    <link rel="stylesheet" href="/version_final/css/admin.css?v=11">
    <link rel="stylesheet" href="/version_final/css/admin/crud-pages.css?v=1">
</head>
<body>
    ...
    <main class="main-content">
        ...
        <div class="admin-page-shell">
            <div class="page-heading">
                <div>
                    <a href="/version_final/paginas/admin/productos.php" class="back-link">
            ...
            <div class="form-card">
                <form action="/version_final/php/controlador/productos/actualizar.php" method="POST">
                    ...
                    <div class="form-actions">
                        <a href="/version_final/paginas/admin/productos.php" class="btn btn-light">
                            Cancelar
                        </a>
