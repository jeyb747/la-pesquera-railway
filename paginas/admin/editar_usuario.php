    ...
    <main class="main-content">
        ...
        <div class="admin-page-shell">
            <div class="page-heading">
                <div>
                    <a href="/version_final/paginas/admin/usuarios.php" class="back-link">
            ...
            <div class="form-card">
                <form action="/version_final/php/controlador/usuarios/actualizar.php" method="POST">
                    ...
                    <div class="form-actions">
                        <a href="/version_final/paginas/admin/usuarios.php" class="btn btn-light">
                            Cancelar
                        </a>
