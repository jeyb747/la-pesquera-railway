...
<head>
    ...
    <link rel="stylesheet" href="/version_final/css/admin.css?v=10">
    <link rel="stylesheet" href="/version_final/css/admin/pedidos.css?v=10">
</head>
                            ...
                            <tr style="border-bottom: 1px solid #edf2f7;">
                                ...
                                <td class="py-3 text-end px-4">
                                    <div class="d-inline-flex gap-2">
                                        ...
                                        <a href="/version_final/php/controlador/pedidos/eliminar.php?id=<?= $row['id'] ?>"
