...
<div class="modal fade" id="modalNuevaColumna" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow rounded-4">
            ...
            <form action="/version_final/php/controlador/admin/procesar_producto.php?accion=crear_columna" method="POST">
...
<div class="modal fade" id="modalEliminarColumna" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow rounded-4">
            ...
            <form action="/version_final/php/controlador/admin/procesar_producto.php?accion=eliminar_columna" method="POST">
                <div class="modal-body p-4">
...
<div class="modal fade" id="modalNuevoProducto" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow rounded-4">
            ...
            <form action="/version_final/php/controlador/admin/procesar_producto.php?accion=crear" method="POST">
                <div class="modal-body p-4">
                    <div class="mb-3">
...
<script>
    function confirmarEliminacion(id) {
        if(confirm("¿Eliminar de forma permanente este producto del sistema?")) {
            window.location.href = "/version_final/php/controlador/admin/procesar_producto.php?accion=eliminar&id=" + id;
        }
    }
</script>
</body>
