...
<div class="modal fade" id="modalNuevoRol" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow rounded-4">
            ...
            <form action="/version_final/php/controlador/admin/procesar_rol.php?accion=crear" method="POST">
...
<div class="modal fade" id="modalEditarRol" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow rounded-4">
            ...
            <form action="/version_final/php/controlador/admin/procesar_rol.php?accion=editar" method="POST">
...
<script>
    ...
    function confirmarEliminacion(id) {
        if(confirm("¿Estás seguro de que deseas eliminar este rol? Esto podría afectar a los usuarios que pertenezcan a este rango.")) {
            window.location.href = "/version_final/php/controlador/admin/procesar_rol.php?accion=eliminar&id=" + id;
        }
    }
</script>
</body>
